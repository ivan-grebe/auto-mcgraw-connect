...
This fork is based on [`GooglyBlox/auto-mcgraw`](https://github.com/GooglyBlox/auto-mcgraw) (originally v2.4/main); the fork is currently at v2.7. The original SmartBook flow is preserved while adding broader McGraw Hill Connect support.
